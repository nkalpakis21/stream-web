          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                disabled={busy || !user}
                className="px-4 py-2.5 bg-accent-cta text-accent-ink rounded-xl hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm"
              >
