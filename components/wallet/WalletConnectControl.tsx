...
const CONNECT_BUTTON_CLASS =
  'w-full px-4 py-2.5 bg-accent-cta text-accent-ink rounded-[12px] hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm shadow-soft';

const QUIET_BUTTON_CLASS =
  'w-full px-3 py-2 bg-accent-cta text-accent-ink rounded-[12px] hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm';
