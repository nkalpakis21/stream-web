  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-4 border-b border-border flex items-center justify-between">
        ...
        <button
          onClick={onNewChat}
          className="p-2 rounded-xl bg-accent-cta text-accent-ink hover:bg-accent-cta/90 transition-colors"
          aria-label="New chat"
        >
      ...
      {conversations.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-muted-foreground">
          ...
          <button
            onClick={onNewChat}
            className="px-4 py-2 rounded-xl bg-accent-cta text-accent-ink hover:bg-accent-cta/90 transition-colors flex items-center gap-2"
          >
