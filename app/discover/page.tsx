          ...
          <form onSubmit={handleSearch} className="mb-6">
            <label className="relative block min-w-0">
              ...
              <input
                ...
                className="h-12 w-full rounded-xl border bg-card pl-12 pr-5 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:border-transparent transition-all"
                style={{
